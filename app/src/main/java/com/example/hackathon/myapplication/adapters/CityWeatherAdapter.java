package com.example.hackathon.myapplication.adapters;
...
public class CityWeatherAdapter extends RecyclerView.Adapter<CityWeatherAdapter.ViewHolder> implements onSwipeListener {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(final CityWeather cityWeather, final OnItemClickListener onItemClickListener){
            ...
            if (cityWeather.getCity().getName().equalsIgnoreCase("Kuwait")) {
                SimpleDateFormat sdf = new SimpleDateFormat("HH:mm");
                String currentDateandTime = sdf.format(new Date());
                tvTime.setText(currentDateandTime+" PM");
                tvTime.setVisibility(View.VISIBLE);


                SimpleDateFormat sdf2 = new SimpleDateFormat("d MMM, yyyy");
                String currentDateandTime2 = sdf2.format(new Date());
                tvDate.setText(currentDateandTime2);
                tvDate.setVisibility(View.VISIBLE);

                cardViewWeather.setCardBackgroundColor(Color.parseColor("#eeeeee"));
            }
