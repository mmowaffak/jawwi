package com.example.hackathon.myapplication.activities;
...
import com.example.hackathon.myapplication.utils.IconProvider;
...
public class WeatherDetails extends AppCompatActivity {
    ...
    @BindView(R.id.textViewDay6) TextView textViewDay6;
    @BindView(R.id.textViewDay7) TextView textViewDay7;
    ...
    @BindView(R.id.imageViewDay6) ImageView imageViewDay6;
    @BindView(R.id.imageViewDay7) ImageView imageViewDay7;
    ...
    @BindView(R.id.textViewMaxTempDay6) TextView textViewMaxTempDay6;
    @BindView(R.id.textViewMaxTempDay7) TextView textViewMaxTempDay7;
    ...
    @BindView(R.id.textViewMinTempDay6) TextView textViewMinTempDay6;
    @BindView(R.id.textViewMinTempDay7) TextView textViewMinTempDay7;
        ...
        for (int i = 1; i < cityWeather.getWeeklyWeather().size(); i++) {
            ...
            switch (i){
                ...
                case 4:
                    ...
                    break;
                case 5:
                    textViewDay6.setText(day);
                    weatherWeekDescription = cityWeather.getWeeklyWeather().get(i).getWeatherDetails().get(0).getShotDescription();
                    Picasso.with(this).load(IconProvider.getImageIcon(weatherWeekDescription)).into(imageViewDay6);
                    textViewMaxTempDay6.setText((int) cityWeather.getWeeklyWeather().get(i).getTemp().getMax()+"°C");
                    textViewMinTempDay6.setText((int) cityWeather.getWeeklyWeather().get(i).getTemp().getMin()+"°C");
                    break;
                case 6:
                    textViewDay7.setText(day);
                    weatherWeekDescription = cityWeather.getWeeklyWeather().get(i).getWeatherDetails().get(0).getShotDescription();
                    Picasso.with(this).load(IconProvider.getImageIcon(weatherWeekDescription)).into(imageViewDay7);
                    textViewMaxTempDay7.setText((int) cityWeather.getWeeklyWeather().get(i).getTemp().getMax()+"°C");
                    textViewMinTempDay7.setText((int) cityWeather.getWeeklyWeather().get(i).getTemp().getMin()+"°C");
                    break;
                default:
                    break;
            }
