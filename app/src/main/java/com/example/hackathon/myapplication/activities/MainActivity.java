...
import com.example.hackathon.myapplication.API.API;
import com.example.hackathon.myapplication.API.APIServices.WeatherServices;
import com.example.hackathon.myapplication.R;
import com.example.hackathon.myapplication.adapters.CityWeatherAdapter;
import com.example.hackathon.myapplication.interfaces.onSwipeListener;
import com.example.hackathon.myapplication.models.CityWeather;
import com.example.hackathon.myapplication.utils.ItemTouchHelperCallback;
...
//        Call<CityWeather> cityWeather = weatherServices.getWeatherCityHourly("Kuwait", API.KEY, "metric",6);
//        cityWeather.enqueue(new Callback<CityWeather>() {
//            @Override
//            public void onResponse(Call<CityWeather> call, Response<CityWeather> response) {
//                if(response.code()==200){
